...
export class CertificateLogic extends CertificateSpecificContract {
    ...
    async approve(_approved: string, _entityId: number, txParams?: SpecialTx) {
        ...
        const txData = await this.web3Contract.methods.approve(_approved, _entityId).encodeABI();
    ...
    async addEscrowForEntity(_certificateId: number, _escrow: string, txParams?: SpecialTx) {
        ...
        const txData = await this.web3Contract.methods
            .addEscrowForEntity(_certificateId, _escrow)
            .encodeABI();
    ...
    async transferFrom(_from: string, _to: string, _entityId: number, txParams?: SpecialTx) {
        ...
        const txData = await this.web3Contract.methods
            .transferFrom(_from, _to, _entityId)
            .encodeABI();
    ...
    async splitCertificate(_certificateId: number, _power: number, txParams?: SpecialTx) {
        ...
        const txData = await this.web3Contract.methods
            .splitCertificate(_certificateId, _power)
            .encodeABI();
    ...
    async splitAndPublishForSale(_certificateId: number, _energy: number, _price: number, _tokenAddress: string, txParams?: SpecialTx) {
        ...
        const txData = await this.web3Contract.methods
            .splitAndPublishForSale(_certificateId, _energy, _price, _tokenAddress)
            .encodeABI();
    ...
    async splitAndBuyCertificate(_certificateId: number, _power: number, txParams?: SpecialTx) {
        ...
        const preparedSplitAndBuyMethod = await this.web3Contract.methods.splitAndBuyCertificate(_certificateId, _power);

        const txData = preparedSplitAndBuyMethod.encodeABI();
        let gas;
        ...
        if (txParams) {
            ...
            if (!txParams.gas) {
                try {
                    gas = await preparedSplitAndBuyMethod.estimateGas({
                            from: txParams ? txParams.from : (await this.web3.eth.getAccounts())[0]
                        });
                } catch (ex) {
                    if (!(await getClientVersion(this.web3)).includes('Parity')) {
        ...
        if (transactionParams.privateKey !== '') {
            ...
            return await preparedSplitAndBuyMethod
                .send({ from: transactionParams.from, gas: transactionParams.gas });
        }
    }
    ...
    async buyCertificate(_certificateId: number, txParams?: SpecialTx) {
        ...
        const txData = await this.web3Contract.methods.buyCertificate(_certificateId).encodeABI();
    ...
    async setApprovalForAll(_escrow: string, _approved: boolean, txParams?: SpecialTx) {
        ...
        const txData = await this.web3Contract.methods
            .setApprovalForAll(_escrow, _approved)
            .encodeABI();
    ...
    async removeEscrow(_certificateId: number, _escrow: string, txParams?: SpecialTx) {
        ...
        const txData = await this.web3Contract.methods
            .removeEscrow(_certificateId, _escrow)
            .encodeABI();
    ...
    async retireCertificate(_certificateId: number, txParams?: SpecialTx) {
        ...
        const txData = await this.web3Contract.methods
            .retireCertificate(_certificateId)
            .encodeABI();
    ...
    async setTradableToken(_entityId: number, _tokenContract: string, txParams?: SpecialTx) {
        ...
        const txData = await this.web3Contract.methods
            .setTradableToken(_entityId, _tokenContract)
            .encodeABI();
