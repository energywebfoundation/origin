...
export class MarketDB extends GeneralFunctions {
    ...
    async setMatcherPropertiesAndURL(
        ...
        const txData = await this.web3Contract.methods
            .setMatcherPropertiesAndURL(_agreementId, _matcherPropertiesDocumentHash, _matcherDBURL)
            .encodeABI();
    ...
    async setAgreementMatcher(_agreementId: number, _matchers: string[], txParams?: SpecialTx) {
        ...
        const txData = await this.web3Contract.methods
            .setAgreementMatcher(_agreementId, _matchers)
            .encodeABI();
    ...
    async createDemand(
        ...
        const txData = await this.web3Contract.methods
            .createDemand(_propertiesDocumentHash, _documentDBURL, _demandOwner)
            .encodeABI();
    ...
    async approveAgreementSupplyDB(_agreementId: number, txParams?: SpecialTx) {
        ...
        const txData = await this.web3Contract.methods
            .approveAgreementSupplyDB(_agreementId)
            .encodeABI();
    ...
    async approveAgreementDemandDB(_agreementId: number, txParams?: SpecialTx) {
        ...
        const txData = await this.web3Contract.methods
            .approveAgreementDemandDB(_agreementId)
            .encodeABI();
