...
import { IOriginConfiguration, UserUpdateData, IUserFilter, IUser, IOwnershipCommitmentProofWithTx, CommitmentStatus, CertificationRequestUpdateData, CertificationRequestValidationData, ICertificationRequest, ISuccessResponse, UserLoginReturnData, UserRegisterReturnData, UserRegistrationData, IUserProperties, UserPasswordUpdate, EmailConfirmationResponse, IEmailConfirmationToken, UpdateUserResponseReturnType, OrganizationPostData, OrganizationUpdateData, OrganizationRole, IOrganizationInvitation, Role, onUploadProgressFunction, IDeviceWithRelationsIds, IExternalDeviceId, DeviceCreateData, DeviceUpdateData, IDevice, ISmartMeterReadWithStatus, ISmartMeterRead, DeviceSettingsUpdateData } from '..';
...
export interface ICertificateClient {
    ...
    addOwnershipCommitment(certificateId: number, data: IOwnershipCommitmentProofWithTx): Promise<CommitmentStatus>;
}
export interface IRequestClient {
    authenticationToken: string;
    get<T extends any, U extends any>(url: string, config?: AxiosRequestConfig): Promise<AxiosResponse<U>>;
    post<T extends any, U extends any>(url: string, data?: T, config?: AxiosRequestConfig): Promise<AxiosResponse<U>>;
    put<T extends any, U extends any>(url: string, data?: T, config?: AxiosRequestConfig): Promise<AxiosResponse<U>>;
    delete<T extends any, U extends any>(url: string, config?: AxiosRequestConfig): Promise<AxiosResponse<U>>;
...
export interface IUserClient {
    ...
    updateAdditionalProperties(properties: Partial<Pick<IUserProperties, 'notifications'>>): Promise<UpdateUserResponseReturnType>;
