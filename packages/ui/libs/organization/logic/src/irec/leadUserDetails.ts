  ...
  fields: [
    {
      ...
      inputProps: { ['data-cy']: 'leadUserTitle' },
    ...
    },
    {
      ...
      label: t('organization.registerIRec.leadUserFirstName'),
      required: true,
      inputProps: { ['data-cy']: 'leadUserFirstName' },
    },
    {
      name: 'leadUserLastName',
      label: t('organization.registerIRec.leadUserLastName'),
      required: true,
      inputProps: { ['data-cy']: 'leadUserLastName' },
    },
    {
      name: 'leadUserEmail',
      label: t('organization.registerIRec.leadUserEmail'),
      required: true,
      inputProps: { ['data-cy']: 'leadUserEmail' },
    },
    {
      name: 'leadUserPhoneNumber',
      label: t('organization.registerIRec.leadUserPhoneNumber'),
      required: true,
      inputProps: { ['data-cy']: 'leadUserPhoneNumber' },
    },
    {
      name: 'leadUserFax',
      label: t('organization.registerIRec.leadUserFax'),
      required: true,
      inputProps: { ['data-cy']: 'leadUserFax' },
    },
  ],
