  ...
  const useStyles = makeStyles({
    ...
    modalWindow: {
      background: LightenColor(
        configuration?.styleConfig?.MAIN_BACKGROUND_COLOR,
        2
      ),
                ...
                return (
                  <>
                    <Form translate="no">
                      ...
                      <FormInput property="description" label={'Description'} />
                      <br />

                      {!device?.timezone && (
                        <>
                          <FormInput property="timezone" label={'Timezone'} />
                          <br />
                        </>
                      )}
