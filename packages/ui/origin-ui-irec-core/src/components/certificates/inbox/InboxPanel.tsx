...
import { fetchMyDevices, getMyDevices } from '../../../features/devices';
import { IInboxCertificateData, IInboxItemData, InboxItem } from '.';
                ...
                ? myDevices
                      ...
                      .map((item) => {
                          return {
                              ...
                              country: item.device.address,
                              type: item.device.deviceType,
                              capacity: item.device.capacity,
