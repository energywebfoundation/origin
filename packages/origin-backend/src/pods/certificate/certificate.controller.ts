...
export class CertificateController {
    ...
    async getOwnershipCommitment(@Param('id') id: number): Promise<IOwnershipCommitmentProof> {
        const certificate = await this.certificateRepository.findOne(id);
    ...
    async approvePendingOwnershipCommitment(@Param('id') id: number): Promise<IOwnershipCommitmentProof> {
        const certificate = await this.certificateRepository.findOne(id);
    ...
    async addOwnershipCommitment(@Param('id') id: number, @Body() proof: IOwnershipCommitmentProof) {
