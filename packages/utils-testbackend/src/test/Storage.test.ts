...
describe('Storage tests', async () => {
    ...
    it('gets all Origin contracts', async () => {
        const putResult = await axios.put(
            'http://localhost:3030/OriginContractLookup/0xb4ec89404c4a24f4c80d157ba9ad803cbc4db614',
            {
        ...
        const getResult = await axios.get('http://localhost:3030/OriginContractLookup');
