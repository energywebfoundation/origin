...
// // import { ContractEventHandler, EventHandlerManager, BlockchainProperties } from 'ewf-coo';
// import { Asset, ProducingAsset, ConsumingAsset } from '@energyweb/asset-registry';
...
//     const possibleOwner = [
//         topAdminAccount.address,
//         '0x71c31ff1faa17b1cb5189fd845e0cca650d215d3',
//         '0x3b07f15efb10f29b3fc222fb7e717e9af0cc4243'
//     ];
...
//             const generatedAsset = await ProducingAsset.CREATE_ASSET(
//                 producingAssetProps,
...
//         const consumingAsset = await ConsumingAsset.CREATE_ASSET(
//             consumingAssetProps,
//             blockchainProperties
//         );
...
// const initDemands = async (topAdminAccount, blockchainProperties): Promise<Demand.Entity> => {
...
//         'British Columbia'
//     ];
//     const enabledProps = [false, false, false, false, false, false, false, false, false, false];

//     const mod1 = currentCreatedDemand & 1;
//     const mod2 = currentCreatedDemand & 2;
//     const mod3 = currentCreatedDemand & 4;
//     const mod4 = currentCreatedDemand & 8;
//     const mod5 = currentCreatedDemand & 16;
//     const mod6 = currentCreatedDemand & 32;
//     const mod7 = currentCreatedDemand & 64;
//     const mod8 = currentCreatedDemand & 128;
...
//         locationRegion:
//             possibleRegion[
//                 (currentCreatedDemand % 3) * 3 +
//                     (currentCreatedDemand % 3) +
//                     (currentCreatedDemand % 1)
//             ],
...
//    */
//         testamount++;
//         const currentDemand = await Demand.CREATE_DEMAND(
//             demandProps,
//             blockchainProperties,
//             topAdminAccount
//         );
...
//         const cooContractInstance = new web3.eth.Contract(
//             (CoOTruffleBuild as any).abi,
//             '0x359c2c4a9cb9dffe672b0979fbeaa717a1ddf118'
//         );
//         const assetProducingRegistryAddress = await cooContractInstance.methods
//             .assetProducingRegistry()
//             .call();
//         const demandLogicAddress = await cooContractInstance.methods.demandRegistry().call();
//         const certificateLogicAddress = await cooContractInstance.methods
//             .certificateRegistry()
//             .call();
//         const assetConsumingRegistryAddress = await cooContractInstance.methods
//             .assetConsumingRegistry()
//             .call();
...
//                 (AssetProducingLogicTruffleBuild as any).abi,
//                 assetProducingRegistryAddress
//             ),
//             demandLogicInstance: new web3.eth.Contract(
//                 (DemandLogicTruffleBuild as any).abi,
//                 demandLogicAddress
//             ),
//             certificateLogicInstance: new web3.eth.Contract(
//                 (CertificateLogicTruffleBuild as any).abi,
//                 certificateLogicAddress
//             ),
//             consumingAssetLogicInstance: new web3.eth.Contract(
//                 (AssetConsumingLogicTruffleBuild as any).abi,
